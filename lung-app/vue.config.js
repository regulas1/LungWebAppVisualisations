...
module.exports = {
    pages: {
      ...
      gasExchange: { /* Can use any name */
        // entry for the page
        entry: 'src/pages/Breathing/GasExchange/main.js', /* Must use correct pathname (ie correct folder name capitalisation) */
        // the source template
        template: 'public/breathing-gas-exchange.html',
        /* Appends "index.html" onto parent directory ("public"), 
        must use page with HTML header (not a section id) */
        filename: 'index.html',
        // when using title option,
